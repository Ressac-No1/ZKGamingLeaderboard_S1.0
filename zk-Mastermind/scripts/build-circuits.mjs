...
for (const path of paths) {
  ...
  const commands = [
    ...
    `snarkjs powersoftau contribute pot13_0000.ptau pot13_0001.ptau --name=\"Contribution\" -v`,
    `snarkjs powersoftau prepare phase2 pot13_0001.ptau pot13_final.ptau -v`,
    `snarkjs groth16 setup circuit.r1cs pot13_final.ptau circuit_0000.zkey -v`,
    ...
    `rm circuit_0000.zkey circuit.r1cs pot13_0000.ptau pot13_0001.ptau pot13_final.ptau`,
    `rm -rf circuit_js`,
